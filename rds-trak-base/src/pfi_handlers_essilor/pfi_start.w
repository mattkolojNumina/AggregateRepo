...
\centerline{Control Date: $ $Date: 2021/05/26 15:44:24 $ $}
}
...
@c
static char rcsid[] = "$Id: pfi_start.w,v 1.2 2021/05/26 15:44:24 rds Exp $";
@<Includes@>@;
@<Defines@>@;
@<Globals@>@;
...
@<create box@>=
{
   ...
   app_update_description( area, seq, area, "start processing" );
}
