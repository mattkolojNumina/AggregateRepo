...
* History:
*   08/09/2002 ank: init
*   02/10/2009 ank; replace RETURN_STRING(empty_string,1) with
*     RETURN_EMPTY_STRING() to compile for php5
***********************************************************************/
#include "php.h"
...
PHP_FUNCTION( rdstrak_rplist ) {
  ...
  if( array_init( return_value ) != SUCCESS )
    /* RETURN_STRING( empty_string, 1 ); */  /* for php4 */
    RETURN_EMPTY_STRING();                   /* for php5 */
