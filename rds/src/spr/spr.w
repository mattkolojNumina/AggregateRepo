...
\centerline{RCS ID: $ $Id: spr.w,v 1.1 2023/09/28 14:02:53 rds Exp $ $}
}
...
@* Overview.
@c
static char rcsid[] = "$Id: spr.w,v 1.1 2023/09/28 14:02:53 rds Exp $" ;
@<Includes@>@;
@<Globals@>@;
@<Prototypes@>@;
@<Functions@>@;
...
char *get_doc( int doc_seq, int *piLen ) {
  ...
  err = sql_query( "SELECT doc FROM docs WHERE docSeq=%d", doc_seq );
