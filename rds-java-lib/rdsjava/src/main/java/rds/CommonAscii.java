 ...
 * CommonAscii.java
 *
 * (c) 2004, Numina Systems Corporation, all rights reserved
 */
...
public class CommonAscii {
   ...
   public static final int MIN_PRINTABLE = SPACE;
   public static final int MAX_PRINTABLE = DEL - 1;
}