...
GeekUpdate
  ...
  class Field
    ...
    public 
    Field(String type, String element)
      {
      this.type = type ;
      this.element = element ;
      this.column  = column ; 
  ...
  public void
  addString(String element, String column)
    {
  ...
  public void
  addString(String element)
    {
    addString(element,element) ;
    }

  public void
  addStringLiteral(String s_value, String column)
    {
  ...
  public void 
  addKeyString(String element, String column)
    {
    Field f = new Field("string",element,column) ;
    f.key = true ;
    fields.add(f) ;
  ...
  public void
  addKeyString(String element)
    {
    addKeyString(element,element) ;
    }

  public void
  addKeyStringLiteral(String s_value, String column)
    {
    Field f = new Field("string","",column) ;
    f.literal = true ;
    f.key     = true ;
  ...
  public void
  addInt(String element, String column)
    {
    if(!object.isNull(element))
      {
  ...
  public void
  addInt(String element)
    {
    addInt(element,element) ;
    }

  public void
  addIntLiteral(int i_value, String column)
    {
  ...
  public void 
  addKeyInt(String element, String column)
    {
    Field f = new Field("int",element,column) ;
    f.key = true ;
    fields.add(f) ;
  ...
  public void
  addKeyInt(String element)
    {
    addKeyInt(element,element) ;
    }

  public void
  addKeyIntLiteral(int i_value, String column)
    {
    Field f = new Field("int","",column) ;
    f.literal = true ;
    f.key     = true ;
  ...
  // long
  public void
  addLong(String element, String column)
    {
    if(!object.isNull(element))
      {
      Field f = new Field("long",element,column) ;
      fields.add(f) ;
      }
    }

  public void
  addLong(String element)
    {
    addLong(element,element) ;
    }

  public void
  addLongLiteral(long l_value, String column)
    {
    Field f = new Field("long","",column) ;
    f.literal = true ;
    f.l_value = l_value ;
    fields.add(f) ;
    }
  ...
  public void
  addLongDate(String element, String column)
    {
    if(!object.isNull(element))
      {
  ...
  public void
  addFloat(String element, String column)
    {
    if(!object.isNull(element))
      {
  ...
  public void
  addFloat(String element)
    {
    addFloat(element,element) ;
    }

  public void
  addFloatLiteral(float f_value, String column)
    {
  ...
  public void 
  addKeyFloat(String element, String column)
    {
    Field f = new Field("float",element,column) ;
    f.key = true ;
    fields.add(f) ;
  ...
  public void
  addKeyFloat(String element)
    {
    addKeyFloat(element,element) ;
    }

  public void
  addKeyFloatLiteral(float f_value, String column)
    {
    Field f = new Field("float","",column) ;
    f.literal = true ;
    f.key     = true ;
  ...
  public void
  addBoolInt(String element, String column)
    {
    if(!object.isNull(element))
      {
  ...
  public void
  addBoolInt(String element)
    {
    addBoolInt(element,element) ;
    }

  public void
  addBoolIntLiteral(boolean b_value, String column)
    {
  ...
  public void 
  addKeyBoolInt(String element, String column)
    {
    Field f = new Field("boolInt",element,column) ;
    f.key = true ;
    fields.add(f) ;
  ...
  public void
  addKeyBoolInt(String element)
    {
    addKeyBoolInt(element,element) ;
    }

  public void
  addKeyBoolIntLiteral(boolean b_value, String column)
    {
    Field f = new Field("boolInt","",column) ;
    f.literal = true ;
    f.key     = true ;
...
// RDSUtil.trace("[%s]",sql) ;
    ...
    try
      ...
      PreparedStatement pstmt 
        = db.connect().prepareStatement(sql) ;
