...
(function()
{
  ...
  diagChooseController.$inject = ['$scope','$http','$interval','$routeParams','Global','DbFactory'];

  function
  diagChooseController($scope,$http,$interval,$routeParams,Global,DbFactory)
  {
    var periodic;
    ...
    var responsiveVertical = false; //set false to always fit entire width
...
//      easelResize();
    ...
    setup()
    {
      ...
      addTile('CP1','#/diag?rds=2300278-Diagnostic-CP-1','scope.svg','#2E258F','Graphical diagnostics: CP1');

      addTile('CP2 Level 1','#/diag?rds=2300278-Diagnostic-CP-2 Level 1','scope.svg','#73246D','Graphical diagnostics: CP2 Level 1');

      addTile('CP2 Level 2','#/diag?rds=2300278-Diagnostic-CP-2 Level 2','scope.svg','#73246D','Graphical diagnostics: CP2 Level 2');

      addTile('CP2 Level 3','#/diag?rds=2300278-Diagnostic-CP-2 Level 3','scope.svg','#73246D','Graphical diagnostics: CP2 Level 3');

      addTile('CP2 Trash','#/diag?rds=2300278-Diagnostic-CP-2 Trash','scope.svg','#73246D','Graphical diagnostics: CP2 Trash');

      addTile('CP3','#/diag?rds=2300278-Diagnostic-CP-3','scope.svg','#73246D','Graphical diagnostics: CP3');

      addTile('CP4','#/diag?rds=2300278-Diagnostic-CP-4','scope.svg','#73246D','Graphical diagnostics: CP4');

      addTile('CP5-6','#/diag?rds=2300278-Diagnostic-CP-5-6','scope.svg','#358F94','Graphical diagnostics: CP5-6');
...
function
    ...
    init()
    {
      ...
      $scope.rds = "images/diagnostic/2300278-Overall.rds";
  ...
  function
    ...
    $routeProvider
      .when('/diagChoose', {
        controller: 'diagChooseController',
