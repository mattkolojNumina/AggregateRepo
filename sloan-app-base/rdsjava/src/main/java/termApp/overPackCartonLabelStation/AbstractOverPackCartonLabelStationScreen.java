 ...
 * behavior.
 */
public abstract class AbstractOverPackCartonLabelStationScreen extends AbstractProjectAppScreen {
   ...
   public AbstractOverPackCartonLabelStationScreen( TerminalDriver term ) {
      super( term );
   ...
   protected String getScale() {
      if (!scaleRuntimeDefined() )
         return "";
      String scaleMsg = rScale+"/msg";
      String result = db.getRuntime( scaleMsg );
   ...
   protected void doCancel(){
   	...
   	setNextScreen("overPackCartonLabelStation.StartScreen");
   }
