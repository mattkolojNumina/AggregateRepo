...
public class PrintPickTicketScreen extends AbstractOverPackCartonPackStationScreen {

   private Button ok,cancel,reprint;
   private int printJobSeq;
   private boolean checkPrintJob;;

   public PrintPickTicketScreen( TerminalDriver term ) {
      super(term) ;
   ...
   protected void doReprint() {
   	showActionMsg("Reprinting pick ticket");
   	startPrintJob();
   }
