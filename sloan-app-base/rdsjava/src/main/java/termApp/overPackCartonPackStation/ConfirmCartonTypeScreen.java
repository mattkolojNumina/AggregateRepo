...
public class ConfirmCartonTypeScreen extends AbstractOverPackCartonPackStationScreen {
   ...
   @Override
	public void initDisplay() {
   	...
   	initButtons();
		initPromptModule(
				String.format("Put items to suggested/selected type"),
				ENTRYCODE_NONE,
				true,
				true);   
   ...
   protected void doConfirm() {
   	...
   	if( selectedCartonType.equals(suggested) ) {
		...
		setNextScreen("overPackCartonPackStation.ScanLpnScreen"); 
   } 
