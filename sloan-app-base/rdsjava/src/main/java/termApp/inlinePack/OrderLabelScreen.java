...
public class OrderLabelScreen extends AbstractInLinePackStationScreen {
   ...
   public OrderLabelScreen( TerminalDriver term ) {
      super(term) ;
   ...
   protected void doReprint() {
      inform("Reprint button pressed");
   	showActionMsg("Reprinting order label");
   	startPrintJob();
   }
