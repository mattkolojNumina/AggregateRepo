...
public class BigScreenCartonStart
extends AbstractBigScreen {
   ...
   public BigScreenCartonStart(TerminalDriver term) {
...
//-----------------------------------DRAWS CARTON COUNTS LIST-----------------------------------
    ...
    private void updateList() {
      ...
      cartonList = getBuildListCartonStart();
   ...
   public void initDisplay() {
      ...
      helloText = new TextField(SCREEN_WIDTH/2, 0, 75, "ZoneRoute Carton Start", Align.CENTER);
...
//         inform("numWaves = [%d], remainingWaves = [%d]", numWaves, remainingWaves);
         while (drawWave == false) {
            bkgdColor = getBackgroundColor(cartonList, i, PICKTYPE_ZONEROUTE);
