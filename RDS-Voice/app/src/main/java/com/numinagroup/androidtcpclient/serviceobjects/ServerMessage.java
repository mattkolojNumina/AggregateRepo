...
/**
 * This class represents a server message that has been sent by the server.
 * A server message has a few pieces of content. It has a message text, a text
...
public class ServerMessage {
     ...
     **/
    public ServerMessage(String messageText, String textColor, String backgroundColor) {
